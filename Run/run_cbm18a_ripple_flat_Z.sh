...
cd $out
rm -f .lock_file*
echo "$debug_opt -- mpirun -np $1 ./PB3D input_cbm18a_ripple wout_cbm18a_ripple_flat_Z.nc $slepc_opt ${@:2}" > command
$debug_opt mpirun -np $1 ./PB3D input_cbm18a_ripple wout_cbm18a_ripple_flat_Z.nc $slepc_opt ${@:2}
cd ../
echo ""
