...
contains
    ...
    subroutine calc_eq(alpha)
        ...
        call lvl_ud(1)
            ...
            do id = 0,3
                call calc_f_deriv(g_F,T_FV,g_F_FD,max_deriv-[1,1,1],derivs(id)) ! g_F
                call calc_f_deriv(h_F,T_FV,h_F_FD,max_deriv-[1,1,1],derivs(id)) ! h_F
