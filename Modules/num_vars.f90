...
module num_vars
    ...
    public dp, dpi, max_str_ln, max_name_ln, max_deriv, prog_name, &
        ...
        &norm_disc_style_sol, POST_style, alpha_style, magn_int_style, &
        &solver_SLEPC_style, max_it_rich, tol_rich, &
    ...
    real(dp), parameter :: prog_version = 2.09_dp                               !< version number
    real(dp), parameter :: min_PB3D_version = 2.08_dp                           !< minimum PB3D version for POST
#if ldebug
