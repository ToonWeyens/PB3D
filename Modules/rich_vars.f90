...
#include <PB3D_macros.h>
    ...
    integer, parameter :: req_min_n_par_X = 20                                  !< required minimum \c n_par_X
    integer :: min_n_par_X                                                      !< min. of \c n_par_X (e.g. first value in Richardson loop)
...
contains
    !> Returns string with  possible extension with Richardson  level or nothing
    !! if only one level and one parallel job.
