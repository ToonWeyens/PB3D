...
#include <PB3D_macros.h>
    ...
    implicit none
    private
    public vars_1D_misc, vars_1D_eq, vars_1D_eq_B, vars_1D_X_1, vars_1D_X_2, &
        &vars_1D_sol, min_PB3D_version, PB3D_version
    ...
    real(dp), parameter :: min_PB3D_version = 1.03_dp                           ! minimum PB3D version
