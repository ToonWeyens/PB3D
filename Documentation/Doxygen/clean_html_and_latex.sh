...
echo GOING TO PUT SHIT AT $hyper_line
...
chap_line=$(grep -n '\chapter{Programs}' refman.tex | cut -f1 -d":")
sed -i $((chap_line-1))'i\\begin{appendices}\' refman.tex
sed -i $((chap_line+0))'i\\appendixpage\' refman.tex
sed -i $((chap_line+1))'i\\noappendicestocpagenum\' refman.tex
sed -i $((chap_line+2))'i\\addappheadtotoc\' refman.tex
