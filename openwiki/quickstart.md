...
- **The vacuum module (`vac_ops.f90`) is explicitly marked incomplete** in its own source comment ("still under construction and not usable yet") — treat any vacuum-related change as higher-risk/experimental.
