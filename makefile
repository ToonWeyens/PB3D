...
##############################################################################
COMP_FLAGS = -finit-real=snan -g -Og -Wall -Wextra -pedantic -fimplicit-none -fbacktrace -fno-omit-frame-pointer -ffpe-trap=invalid -fcheck=all -cpp -Dldebug# debug, profiling with gprof2dot, GCC
